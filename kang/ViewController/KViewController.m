...
- (void)viewDidLoad {
    ...
    //    self.navigationController.interactivePopGestureRecognizer.delegate = (id)self; // 左侧滑动返回
...
- (void) leftButtonTitle:(NSString *)title
{
    ...
    textLabel.frame = CGRectMake(CGRectGetMaxX(imgView.frame), 0, titleWidth, btnHeight) ;
...
{
    return [[UIImageView alloc] initWithImage:[UIImage imageNamed:@""]] ;
}
